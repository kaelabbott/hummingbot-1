...
from hummingbot.connector.exchange.bitblinx.bitblinx_exchange import BitblinxExchange
...
class BitblinxExchangeUnitTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.market: BitblinxExchange = BitblinxExchange(
            API_KEY,
    ...
    def setUp(self):
        self.db_path: str = realpath(join(__file__, "../bitblinx_test.sqlite"))
        try:
    ...
    def test_get_balance(self):
        balance = self.market.get_balance(base_asset)
        print(balance)
    ...
    def test_cancel_all(self):
        ...
        [cancellation_results] = self.run_parallel(self.market.cancel_all(55))
