...
from hummingbot.connector.derivative.ftx_perpetual.ftx_perpetual_order_book_message import FtxPerpetualOrderBookMessage
...
class FtxPerpetualOrderBook(OrderBook):
    ...
    def snapshot_message_from_exchange(cls,
        ...
        :return: FtxPerpetualOrderBookMessage
        """
