...
from .bitblinx_auth import BitblinxAuth
from .bitblinx_websocket import BitblinxWebsocket


class BitblinxAPIUserStreamDataSource(UserStreamTrackerDataSource):
    MAX_RETRIES = 20
    ...
    def __init__(self, bitblinx_auth: BitblinxAuth, trading_pairs: Optional[List[str]] = []):
