...
class BitblinxExchange(ExchangeBase):
    """
    ...
    def restore_tracking_states(self, saved_states: Dict[str, any]):
        ...
        self._in_flight_orders.update({
            key: BitblinxInFlightOrder.from_json(value)
    ...
    async def check_network(self) -> NetworkStatus:
        ...
        try:
            ...
            await self._api_request("get", "symbols/BTC-USDT")
        except asyncio.CancelledError:
            raise
        except Exception:
    ...
    def _format_trading_rules(self, symbol_info: Dict[str, Any]) -> Dict[str, TradingRule]:
        """
    ...
    def sell(self, trading_pair: str, amount: Decimal, order_type=OrderType.MARKET,
        ...
        :returns A new internal order id
        """
        order_id: str = bitblinx_utils.get_new_client_order_id(False, trading_pair)
    ...
    def start_tracking_order(self,
        ...
        """
        self._in_flight_orders[order_id] = BitblinxInFlightOrder(
