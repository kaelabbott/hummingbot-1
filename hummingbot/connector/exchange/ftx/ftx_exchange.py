...
from hummingbot.connector.exchange.ftx.ftx_client import FtxClient
ctce_logger = None
...
class FtxExchange(ExchangeBase):
    ...
    def _format_trading_rules(self, symbol_info) -> Dict[str, TradingRule]:
        ...
        for rule in symbol_info:
            try:
                ...
                result[trading_pair] = TradingRule(ftx_utils.convert_to_exchange_trading_pair(trading_pair),
    ...
    def buy(self, trading_pair: str, amount: Decimal, order_type=OrderType.MARKET,
        ...
        """
        order_id: str = ftx_utils.get_new_client_order_id(True, trading_pair)
    ...
    def sell(self, trading_pair: str, amount: Decimal, order_type=OrderType.MARKET,
        ...
        :returns A new internal order id
        """
        order_id: str = ftx_utils.get_new_client_order_id(False, trading_pair)
    ...
    async def _create_order(self,
        ...
        self.start_tracking_order(order_id,
                                  None,
                                  ftx_utils.convert_to_exchange_trading_pair(trading_pair),
                                  trade_type,
                                  price,
                                  amount,
                                  order_type
    ...
    def start_tracking_order(self,
        ...
        self._in_flight_orders[order_id] = FtxInFlightOrder(
            ...
            trading_pair=ftx_utils.convert_to_exchange_trading_pair(trading_pair),
    ...
    async def _process_trade_message(self, trade_msg: Dict[str, Any]):
        ...
        self.trigger_event(
            ...
            OrderFilledEvent(
                ...
                ftx_utils.convert_to_exchange_trading_pair(tracked_order.trading_pair),
