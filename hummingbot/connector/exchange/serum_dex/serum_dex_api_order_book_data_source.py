...
from hummingbot.connector.exchange.serum_dex.serum_dex_websocket import SerumDexWebsocket
from hummingbot.connector.exchange.serum_dex.serum_dex_utils import convert_to_exchange_trading_pair_ws, timestamp_to_int
from hummingbot.connector.exchange.serum_dex.serum_dex_active_order_tracker import FtxActiveOrderTracker
...
class SerumDexAPIOrderBookDataSource(OrderBookTrackerDataSource):
    ...
    async def get_new_order_book(self, trading_pair: str) -> OrderBook:
        async with aiohttp.ClientSession() as client:
            ...
            snapshot_msg: OrderBookMessage = SerumDexOrderBook.snapshot_message_from_exchange(
                snapshot,
                snapshot_timestamp,
                ...
                for trading_pair in trading_pairs:
                    ...
                    async for response in ws.on_message_public():
                        ...
                        for trade in response["data"]:
                            ...
                            trade_msg: OrderBookMessage = SerumDexOrderBook.trade_message_from_exchange(
                                trade,
