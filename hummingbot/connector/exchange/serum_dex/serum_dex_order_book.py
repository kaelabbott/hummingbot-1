...
from hummingbot.connector.exchange.serum_dex.serum_dex_order_book_message import SerumDexOrderBookMessage

_logger = None


class SerumDexOrderBook(OrderBook):
    @classmethod
    ...
    def snapshot_message_from_exchange(cls,
        ...
        :return: SerumDexOrderBookMessage
        """
