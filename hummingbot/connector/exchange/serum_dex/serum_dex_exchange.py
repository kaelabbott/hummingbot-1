...
from hummingbot.connector.exchange.serum_dex.serum_dex_order_book_tracker import SerumDexOrderBookTracker
from hummingbot.connector.exchange.serum_dex.serum_dex_user_stream_tracker import SerumDexUserStreamTracker
from hummingbot.connector.exchange.serum_dex.serum_dex_auth import SerumDexAuth
from hummingbot.connector.exchange.serum_dex.serum_dex_in_flight_order import SerumDexInFlightOrder
from hummingbot.connector.exchange.serum_dex import serum_dex_utils
from hummingbot.connector.exchange.serum_dex.serum_dex_client import SerumDexClient
ctce_logger = None
s_decimal_NaN = Decimal("nan")


class SerumDexExchange(ExchangeBase):
    """
    FtxExchange connects with Serum and provides order book pricing, user account tracking and
    ...
    def __init__(self,
                 serum_dex_api_key: str,
                 serum_dex_secret_key: str,
        ...
        self._ftx_auth = SerumDexAuth(serum_dex_api_key, serum_dex_secret_key, ftx_subaccount_name)
        self._order_book_tracker = SerumDexOrderBookTracker(trading_pairs=trading_pairs)
        self._user_stream_tracker = SerumDexUserStreamTracker(self._ftx_auth, trading_pairs)
        ...
        self._api_rest_client = SerumDexClient(serum_dex_api_key, serum_dex_secret_key, ftx_subaccount_name)
    ...
    @property
    def in_flight_orders(self) -> Dict[str, SerumDexInFlightOrder]:
    ...
    def restore_tracking_states(self, saved_states: Dict[str, any]):
        ...
        self._in_flight_orders.update({
            key: SerumDexInFlightOrder.from_json(value)
    ...
    async def _update_trading_rules(self):
        symbol_info = self._api_rest_client.list_markets()
    ...
    def _format_trading_rules(self, symbol_info) -> Dict[str, TradingRule]:
        ...
        {'ask': 18488.5,
         'baseCurrency': 'BTC',
         'bid': 18477.5,
         'change1h': 0.010637716035878363,
         'change24h': 0.022521650112054894,
         'changeBod': 0.008294000491092135,
         ...
         'priceIncrement': 0.5,
         'quoteCurrency': 'USDT',
         'quoteVolume24h': 11476708.17255,
         'restricted': False,
          'sizeIncrement': 0.0001,
          'type': 'spot',
          'underlying': None,
          'volumeUsd24h': 11486399.563999228
          }
        """
        result = {}
        for rule in symbol_info:
            try:
                trading_pair = rule["name"].replace('/', '-')
                price_decimals = Decimal(str(rule["priceIncrement"]))
                quantity_decimals = Decimal(str(rule["minProvideSize"]))
                result[trading_pair] = TradingRule(serum_dex_utils.convert_to_exchange_trading_pair(trading_pair),
    ...
    def buy(self, trading_pair: str, amount: Decimal, order_type=OrderType.MARKET,
        ...
        """
        order_id: str = serum_dex_utils.get_new_client_order_id(True, trading_pair)
    ...
    def sell(self, trading_pair: str, amount: Decimal, order_type=OrderType.MARKET,
        ...
        :returns A new internal order id
        """
        order_id: str = serum_dex_utils.get_new_client_order_id(False, trading_pair)
    ...
    async def _create_order(self,
        ...
        api_params = {"market": trading_pair.replace('-', '/'),
        ...
        self.start_tracking_order(order_id,
                                  None,
                                  serum_dex_utils.convert_to_exchange_trading_pair(trading_pair),
                                  trade_type,
                                  price,
                                  amount,
                                  order_type
    ...
    def start_tracking_order(self,
        ...
        """
        self._in_flight_orders[order_id] = SerumDexInFlightOrder(
            client_order_id=order_id,
            exchange_order_id=exchange_order_id,
            trading_pair=serum_dex_utils.convert_to_exchange_trading_pair(trading_pair),
    ...
    async def _process_trade_message(self, trade_msg: Dict[str, Any]):
        ...
        self.trigger_event(
            ...
            OrderFilledEvent(
                ...
                serum_dex_utils.convert_to_exchange_trading_pair(tracked_order.trading_pair),
