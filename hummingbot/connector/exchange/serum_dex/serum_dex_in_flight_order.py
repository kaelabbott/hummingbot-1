...
class SerumDexInFlightOrder(InFlightOrderBase):
    def __init__(self,
                 client_order_id: str,
    ...
    def is_done(self) -> bool:
        return self.last_state in {"FILLED", "CANCELED", "REJECTED", "EXPIRED", 'closed'}
    ...
    def is_cancelled(self) -> bool:
        return self.last_state in {"cancelled", "EXPIRED", "closed"}
